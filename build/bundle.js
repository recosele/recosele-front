    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 60, 4, 2197);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$1, 57, 4, 2029);
    			attr_dev(button1, "class", "button is-rounded is-success");
    			add_location(button1, file$1, 58, 4, 2106);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(canvas, "class", "svelte-10h0pve");
    			add_location(canvas, file$1, 53, 0, 1931);
    			attr_dev(video, "id", "camera");
    			attr_dev(video, "kind", "captions");
    			attr_dev(video, "class", "svelte-10h0pve");
    			add_location(video, file$1, 54, 0, 1954);
    			attr_dev(div, "id", "actions");
    			attr_dev(div, "class", "svelte-10h0pve");
    			add_location(div, file$1, 55, 0, 1992);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
