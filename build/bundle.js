...
var app = (function () {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('showErr' in $$props) showErr = $$props.showErr;
    	};
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button1, "click", /*handleOK*/ ctx[3], false, false, false)
    				];
    ...
    function create_fragment$2(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*image*/ ctx[0]) return create_if_block;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function capture() {
    		...
    		$$invalidate(0, image = canvasRef.toDataURL('image/jpeg'));
    	}
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file, 15, 4, 564);
    			...
    			add_location(img1, file, 16, 4, 617);
    			...
    			add_location(img2, file, 17, 4, 670);
    			add_location(div, file, 14, 2, 554);
    			add_location(main, file, 13, 0, 545);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*values*/ 1 && !src_url_equal(img0.src, img0_src_value = /*values*/ ctx[0].front_img1)) {
    				attr_dev(img0, "src", img0_src_value);
    			}

    			if (dirty & /*values*/ 1 && !src_url_equal(img1.src, img1_src_value = /*values*/ ctx[0].front_img2)) {
    				attr_dev(img1, "src", img1_src_value);
    			}

    			if (dirty & /*values*/ 1 && !src_url_equal(img2.src, img2_src_value = /*values*/ ctx[0].back_img)) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	frontImg1 === null || frontImg1 === void 0
    	? void 0
    	: frontImg1.subscribe(v => $$invalidate(0, values.front_img1 = v, values));

    	frontImg2 === null || frontImg2 === void 0
    	? void 0
    	: frontImg2.subscribe(v => $$invalidate(0, values.front_img2 = v, values));

    	backImg === null || backImg === void 0
    	? void 0
    	: backImg.subscribe(v => $$invalidate(0, values.back_img = v, values));
    	...
    	$$self.$capture_state = () => ({ frontImg1, frontImg2, backImg, values });
